...
public class WeightedVectorMaker implements VectorMaker<Issue> {
	final boolean onlyUseColors;
	
	public WeightedVectorMaker(boolean onlyUseColors) {
		this.onlyUseColors = onlyUseColors;
	}
	...
	public int vectorSize() {
		//return 18;
		return onlyUseColors? 4: 18;
	}

	@Override
	public String name() {
		return "Weighted " + (onlyUseColors?"only colors":"all");
	}
